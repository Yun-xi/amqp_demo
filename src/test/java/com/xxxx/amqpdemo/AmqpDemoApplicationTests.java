package com.xxxx.amqpdemo;

import com.xxxx.amqpdemo.entity.Order;
import com.xxxx.amqpdemo.entity.Packaged;
import com.xxxx.amqpdemo.producer.RabbitSender;
...
//			rabbitTemplate.send("", "image_queue", message);
    ...
    public void testSender1() throws Exception {
        ...
        properties.put("send_time", "2019-09-16");
        rabbitSender.send("Hello RabbitMQ Spring Boot", properties);
    }

    @Test
    public void testSender2() throws Exception {
        Order order = new Order("001", "第一个订单", "第一个订单");
